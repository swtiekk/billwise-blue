...
// Put EXPO_PUBLIC_API_URL in billwise-blue/.env, then restart with `npx expo start -c`.
//   physical phone / Expo Go : http://<your-PC-LAN-IP>:8000
//   Android emulator         : http://10.0.2.2:8000
//   iOS simulator            : http://localhost:8000
export const BASE_URL = (process.env.EXPO_PUBLIC_API_URL ?? "http://192.168.254.120:8000").replace(/\/$/, "");
